...
#if _SE
static unsigned char table_codec[120] =
{
...
// Copie un nom de fichier en ajouter la lettre supplémentaire.
// Par exemple, "buzzingcars1.dat" devient "buzzingcars1b.dat".
