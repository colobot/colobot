...
void CRobotMain::ChangePhase(Phase phase)
{
    ...
    if (m_phase == PHASE_SIMUL)
    {
        ...
        try
        {
            CLevelLoader::CreateScene(m_ui->GetSceneSoluce(), false, levelLoadMode);  // interactive scene
            if (m_mapImage)
    ...
    if (m_phase == PHASE_WIN)
    {
        ...
        else
        {
            ...
            try
            {
                CLevelLoader::CreateScene(false, true, LevelLoadMode::Normal);  // sets scene
...
void CRobotMain::ResetCreate()
{
    ...
    try
    {
        CLevelLoader::CreateScene(m_ui->GetSceneSoluce(), false, LevelLoadMode::Reset);
