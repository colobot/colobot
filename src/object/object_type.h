...
enum ObjectType
{
    ...
    //OBJECT_NULL         = 1000,    // objet d�truit
    //OBJECT_FIX          = 1001,    // d�cor fixe
    OBJECT_PIECE        = 1002,    // pi�ce de voiture
...
//    OBJECT_TOWER        = 1030,   // tour de d�fense
//    OBJECT_NUCLEAR      = 1031,   // centrale nucl�aire
//    OBJECT_START        = 1032,   // d�part
//    OBJECT_END          = 1033,   // arriv�e
//    OBJECT_PARA         = 1034,   // paratonnerre
    OBJECT_SUPPORT      = 1035,   // pr�sentoir
    OBJECT_DOCK         = 1036,   // portique
    OBJECT_REMOTE       = 1037,   // t�l�commande
    OBJECT_STAND        = 1038,   // tribune
    OBJECT_GENERATOR    = 1039,   // g�n�rateur
...
//    OBJECT_REPAIR       = 1046,   // center de r�paration
...
//    OBJECT_TNT          = 1159,  // caisse de TNT
    ...
    OBJECT_HELICO       = 1171,  // h�licopt�re
    OBJECT_COMPASS      = 1172,  // boussole
    OBJECT_BLITZER      = 1173,  // �lectrocuteur
...
//    OBJECT_MOBILEtg     = 1300,  // cible d'exercice
    ...
    OBJECT_EVIL1        = 1330,  // m�chant 1
    OBJECT_EVIL2        = 1331,  // m�chant 2
    OBJECT_EVIL3        = 1332,  // m�chant 3
    OBJECT_EVIL4        = 1333,  // m�chant 4
    OBJECT_EVIL5        = 1334,  // m�chant 5
    OBJECT_CARROT       = 1340,  // carotte � suivre
...
//    OBJECT_KEYa         = 1370,  // cl� a
//    OBJECT_KEYb         = 1371,  // cl� b
//    OBJECT_KEYc         = 1372,  // cl� c
//    OBJECT_KEYd         = 1373,  // cl� d
//    OBJECT_HUMAN        = 1400,  // homme
//    OBJECT_TECH         = 1402,  // technicien
//    OBJECT_BARRIER0     = 1500,  // barri�re
//    OBJECT_BARRIER1     = 1501,  // barri�re
//    OBJECT_BARRIER2     = 1502,  // barri�re
//    OBJECT_BARRIER3     = 1503,  // barri�re
    OBJECT_BARRIER4     = 1504,  // barri�re
    OBJECT_BARRIER5     = 1505,  // barri�re
    OBJECT_BARRIER6     = 1506,  // barri�re
    OBJECT_BARRIER7     = 1507,  // barri�re
    OBJECT_BARRIER8     = 1508,  // barri�re
    OBJECT_BARRIER9     = 1509,  // barri�re
    OBJECT_BARRIER10    = 1510,  // barri�re
    OBJECT_BARRIER11    = 1511,  // barri�re
    OBJECT_BARRIER12    = 1512,  // barri�re
    OBJECT_BARRIER13    = 1513,  // barri�re
    OBJECT_BARRIER14    = 1514,  // barri�re
    OBJECT_BARRIER15    = 1515,  // barri�re
    OBJECT_BARRIER16    = 1516,  // barri�re
    OBJECT_BARRIER17    = 1517,  // barri�re
    OBJECT_BARRIER18    = 1518,  // barri�re
    OBJECT_BARRIER19    = 1519,  // barri�re
    ...
    OBJECT_PIECE0       = 1540,  // pi�ce
    OBJECT_PIECE1       = 1541,  // pi�ce
    OBJECT_PIECE2       = 1542,  // pi�ce
    OBJECT_PIECE3       = 1543,  // pi�ce
    OBJECT_PIECE4       = 1544,  // pi�ce
    OBJECT_PIECE5       = 1545,  // pi�ce
    OBJECT_PIECE6       = 1546,  // pi�ce
    OBJECT_PIECE7       = 1547,  // pi�ce
    OBJECT_PIECE8       = 1548,  // pi�ce
    OBJECT_PIECE9       = 1549,  // pi�ce
...
//    OBJECT_HOME1        = 1910,  // maison 1
    ...
    OBJECT_BUILDING1    = 1940,  // b�timent
    OBJECT_BUILDING2    = 1941,  // b�timent
    OBJECT_BUILDING3    = 1942,  // b�timent
    OBJECT_BUILDING4    = 1943,  // b�timent
    OBJECT_BUILDING5    = 1944,  // b�timent
    OBJECT_BUILDING6    = 1945,  // b�timent
    OBJECT_BUILDING7    = 1946,  // b�timent
    OBJECT_BUILDING8    = 1947,  // b�timent
    OBJECT_BUILDING9    = 1948,  // b�timent
    OBJECT_BUILDING10   = 1949,  // b�timent
