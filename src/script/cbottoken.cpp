...
std::string GetHelpFilename(const char *token)
{
    ...
    if ( strcmp(token, "sin"           ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "cos"           ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "tan"           ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "asin"          ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "acos"          ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "atan"          ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "atan2"         ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "sqrt"          ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "pow"           ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "rand"          ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "abs"           ) == 0 )  helpfile = "cbot/expr";
    if ( strcmp(token, "floor"         ) == 0 )  helpfile = "cbot/expr";
