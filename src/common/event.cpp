...
void InitializeEventTypeTexts()
{
    ...
    EVENT_TYPE_TEXT[EVENT_OBJECT_PRODUCE]    = "EVENT_OBJECT_PRODUCE";
    EVENT_TYPE_TEXT[EVENT_OBJECT_PANT]       = "EVENT_OBJECT_PANT";
    EVENT_TYPE_TEXT[EVENT_OBJECT_PBEE]       = "EVENT_OBJECT_PBEE";
    EVENT_TYPE_TEXT[EVENT_OBJECT_PSPIDER]    = "EVENT_OBJECT_PSPIDER";
    EVENT_TYPE_TEXT[EVENT_OBJECT_PWORM]      = "EVENT_OBJECT_PWORM";
    EVENT_TYPE_TEXT[EVENT_OBJECT_PNEST]      = "EVENT_OBJECT_PNEST";
